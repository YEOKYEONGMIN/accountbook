...
public class RoundBtn extends Component {
    ...
    public Dimension getPreferredSize() {
        ...
        if (f != null) {
            FontMetrics fm = getFontMetrics(getFont());
//            int xmax = Math.max(fm.stringWidth(label)+10 , fm.getHeight()+10);
            int xmax =fm.stringWidth(label)+25;
            int ymax= fm.getHeight()+10;
